...
def imshow_det_bboxes(img,
    ...
    import random
    # bbox_color = [[random.randint(0, 255)/255 for _ in range(3)] for _ in range(len(labels))]
    ...
    if show:
        ...
        if wait_time == 0:
            # plt.savefig('/home/fanxinyu/mmdetection-master/demo/result_mr/zcj SZ1800070 J46-1 556B.tif')
            plt.show()
        else:
